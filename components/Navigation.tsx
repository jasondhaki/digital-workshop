 ...
 * Updated to a 7-stage sequence (00-06) for the full workshop audit.
 */
export default function Navigation() {
  ...
  const navItems = [
    ...
    { id: "process",  label: language === "en" ? "PROCESS" : "PROCESSUS" },
    ...
    <nav className="fixed right-6 top-1/2 -translate-y-1/2 z-[100] hidden xl:flex flex-col gap-8 items-end">
      {navItems.map((item, idx) => (
        ...
        >
          ...
          <span className="opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 font-mono text-[10px] text-workshop-accent tracking-tighter">
            // {item.label}
          </span>
