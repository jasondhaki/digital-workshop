  ...
  return (
    <footer className="w-full border-t border-workshop-slate/20 py-8 px-6 bg-workshop-bg">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {/* System Diagnostics */}
        <div className="flex items-center gap-6 font-mono text-[12px] text-workshop-slate">
        ...
        {/* Ownership Credits */}
        <div className="text-center md:text-right font-mono text-[12px] text-workshop-slate leading-relaxed">
